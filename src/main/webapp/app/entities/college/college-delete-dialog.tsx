...
export const CollegeDeleteDialog = (props: ICollegeDeleteDialogProps) => {
  useEffect(() => {
  ...
  const confirmDelete = () => {
    props.deleteEntity(props.collegeEntity.id);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="myReactProjectApp.college.delete.question">Are you sure you want to delete this College?</ModalBody>
      <ModalFooter>
        <Button color="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Cancel
        </Button>
        <Button id="jhi-confirm-delete-college" color="danger" onClick={confirmDelete}>
...
const mapStateToProps = ({ college }: IRootState) => ({
  ...
  updateSuccess: college.updateSuccess
});
